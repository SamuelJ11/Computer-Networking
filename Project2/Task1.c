...
{
    clientthread_metadata *packetdata = (clientthread_metadata *)arg; /* initialize client_thread_data_t struct within the thread */
    calcTimeIntval packettiming; /* initialize calcTimeIntval struct */
